    ...
    <div class="col-md-10">
        ...
        <div class="col-md-12" style="background: white;    margin-left: 10px;padding-bottom: 100px;width: 99%;    padding-left: 4.2%;">  
            <form> 
                ...
                <div class="row" style="text-align: right;padding: 0px;    margin-left: 1%;">
                    <div class="row col-md-6" style="border-bottom: 1px dotted rgb(221, 221, 221);margin: 0px 0px 20px;padding: 0px;"> 
                        <p class="H3_1" style="float: left;">Domicilios</p>
                        <a href="#" title="Necesito ayuda" >Necesito ayuda</a>
                    </div>  
                    @isset(auth()->user()->domicilio)
                       <div class="row col-md-6" style="float:none;border-bottom: 1px dotted rgb(221, 221, 221);margin: 0px 0px 20px;padding: 0px;"> 
                            <ul class="ml-addresses__list"> 
                                <li class="ml-addresses__list-item">
                                    <div class="ml-addresses-data">
                                        <dl>
                                            <dt>Direccion:</dt>
                                            <dd class="ml-addresses-data__item ml-addresses-data__item--strong">Venice 3562 SN</dd>
                                            <dt>Datos Adicionales:</dt>
                                            <dd class="ml-addresses-data__item">Venice Y Blvrd California </dd>

                                            <dt>Referencias:</dt>
                                            <dd class="ml-addresses-data__item">Es un abarrote cremeria los Angeles esta en la esquina</dd>

                                            <dt>Localidad:</dt>
                                            <dd class="ml-addresses-data__item">Sinaloa(80014), Culiacán</dd>
                                        </dl> 
                                    </div>
                            ...
                            <ul id="primerMenuUL" class="ch-dropdown-content ch-hide ch-points-ltlb" role="menu" aria-hidden="true" style="position: absolute;left: -180%;top: 85.9%;z-index: 1;overflow: hidden;border-radius: 5px 5px 5px 5px;    -webkit-box-shadow: 2px 2px 2px hsla(0,0%,39%,.2);
        box-shadow: 2px 2px 2px hsla(0,0%,39%,.2);border: 1px solid #dedede;    text-align: left;color: black">
                                <a role="menuitem"></a> 
                                    <li class="masiveActionOption cannot reactivate" style="margin-bottom:10px;    padding: 3px;">                                
                                        <a href="" style="padding:0px;margin:0px;"><p style="color: black;padding-bottom: 5px;">Modificar</p></a>                                
                                    </li>
                                    <li class="masiveActionOption cannot finalize" style="margin-bottom:10px;    padding: 3px;">                                
                                        <a href="" style="padding:0px;margin:0px;"><p style="color: black;padding-bottom: 5px;">Usar para compras</p></a>
                                    </li> 
                            </ul>
                        </div> 
                                    ...
                                    <noscript>
                                    <input type="checkbox" id="toggleVisibleCheckbox" value="false" disabled >
                                    <a href="toggleVisible" rel="nofollow"> Quiero que mis compradores reciban mi domicilio junto con mis datos de contacto. </a>
                                    </noscript>
                                    </div> 
                                </li>      
                            </ul> 
