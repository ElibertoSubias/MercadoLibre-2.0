    ...
    float: left;">
			...
			<div style="width: 30%;width: 30%;display: inline-block;">
				<nav id="nav-menu-cabecera"> 
					<label onmouseover="abrirMenu()" id="userswitch" class="nav-header-user-switch" tabindex="4"><span><span class="nav-header-avatar-user" data-js="user-menu:nav-header-avatar-user"><img src="https://mla-s2-p.mlstatic.com/754093-MLA28045465991_082018-S.jpg" srcset="https://mla-s2-p.mlstatic.com/754093-MLA28045465991_082018-G.jpg 2x" alt="ELIBERTOSUBIAS" class="nav-header-avatar-user-img" height="20" width="20"></span><span class="nav-header-username">{{ auth()->user()->nombre }}</span><span class="nav-header-username-chevron"></span></span></label>
					...
					<span id="detonador"><div id="info_user" onmouseleave="cerrarMenu()">
								...
								<div class="user-menu__user-badge">
									<div class="user-menu__user-badge-image">
										...
										<form data-js="user-menu:avatar-form" method="POST" action="" enctype="multipart/form-data" class="user-menu__avatar-form">
											...
											<img data-js="user-menu:avatar-picture" src="https://mla-s2-p.mlstatic.com/754093-MLA28045465991_082018-S.jpg" class="user-menu__avatar-picture">
						...
						<div id="info_menu" style="float: right;margin-right: 100px;">       
							...
							<a href="" data-id="sales" rel="nofollow">Ventas</a>
