...
<div class="row col-md-8 col-md-offset-2"> 
			<div class="col-md-10 col-md-offset-1"> 
				<h3 style="font-weight: 600;display: inline-block;float: left;">Completa tus datos de tu empresa</h3> 
				<a href="{{route('crearcuentapersonal')}}" title="" style="float: right;margin-top: 25px;text-decoration: none; display: inline-block;color: #3483fa;">Crear una cuenta personal</a> 
			</div>
			<?php if(isset($data)){echo $data[0]->id;}else{}?>
			<div class="col-md-10 col-md-offset-1"> 
				{!! Form::open(['url'=>'login', 'method'=>'POST', 'id'=>'frmInsertarEmpresa', 'name'=>'frmInsertarUsuario','autocomplete'=>'off']) !!} 
				<input type="hidden" name="_token" value="{{ csrf_token() }}" id="token"> 
					<div id="cont-form1" style="background: #fff;    display: table;padding: 1px 32px 60px;box-shadow: 0 1px 3px 0 rgba(0,0,0,.3);-webkit-border-radius: 0 0 4px 4px;border-radius: 0 0 4px 4px;">
						<div class="col-md-6" style="height: 30px;"> 
							{!!Form::text('rfc',null,['class'=>'form-control','id'=>'inputNombre'])!!}
							{!!Form::label('RFC', null, array('id' => 'lblMsjinputNombre'))!!}
							<div id="alertMsjinputNombre" class="ch-validation-message ui-form__message">Completa este dato.</div>
						</div>
						<div class="col-md-6" style="height: 30px;">
							{!!Form::text('razonSocial',null,['class'=>'form-control','id'=>'inputApellido','autocomplete'=>'new-apellido'])!!}
							{!!Form::label('Razón social', null, array('id' => 'lblMsjinputApellido'))!!}  
			...
			<div class="col-md-10 col-md-offset-1" style="margin-top: 30px"> 
				<div class="col-md-4" style="text-align: -webkit-left;padding-left: 0px;"> 
					{!!link_to('#', $title='Crear cuenta', $attributes = ['id'=>'crearCuentaEmpresarial','class'=>'col-md-12 btn btn-primary btn-lg','name'=>'crearUsuario','style'=>'outline: 0px;background: #3483fa;border-color: #3483fa;'], $secure = null)!!} 
				</div>
    ...
    <div class="modal-dialog" style="width: 350px;">
      <div class="modal-content" style="margin: 60% auto;">
        ...
        <div class="modal-body" style="border-bottom: 0px;">
        	...
        	<button  data-dismiss="modal" aria-hidden="true" type="button" class="btn btn-lg" style="background-color: #fff;color: rgba(52,131,250,.65);margin-top: 5px;outline:none;">Registrarme usando otro e-mail</button>
        </div> 
      </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
  </div><!-- /.modal -->
