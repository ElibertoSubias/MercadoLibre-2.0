			...
			@if(Auth::check()) 
        		<div style="width: 30%;display: inline-block;text-align: right;">
					<nav id="nav-menu-cabecera"> 
						...
						<a style="padding-right: 0px" href="{{route('carrito')}}" title="Carrito de compras" class="nav-cart nav-cart-empty" id="nav-cart"><img style="vertical-align: baseline;" src="img/icon_car.png" alt="" width="19"></a><span class="nav-icon-cart-quantity">1</span>
					</nav>		
				</div>
        	@else
