                            ...
                            <div class="ui-dropdown custom"> 
                                ...
                                <label for="sort-by-options-trigger" class="ui-dropdown__link"> <span class="tituloOpcion">Más relevantes</span> 
                                    <div class="ui-dropdown__indicator">
                                        <img style="    transform: rotate(90deg);height: 15px;" src="/MercadoLibre-2.0/public/img/less.png" alt="insertar SVG con la etiqueta image">
                                    </div> 
                                </label> 
                        ...
                        <dd class="filters__group__option" role="option"> 
                            <h3> 
                                <a class="qcat-truncate " style="max-width:137px;" title="A Carbón" href="https://hogar.mercadolibre.com.mx/asadoras-accesorios-a-carbon/asador" rel="nofollow"> 
                                    <span class="filter-name">{{$articulo->categoria}}</span> 
