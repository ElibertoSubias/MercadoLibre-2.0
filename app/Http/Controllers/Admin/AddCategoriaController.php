    ...
    public function showDescrip(Request $request)
    {
        ...
        switch ($request->tipoVenta) {
            ...
            case 'SERV':
                ...
                break;
            case 'PROD':
                return view('vender.descripcionPROD')->with(['titulo'=>$request->titulo,'idPublicacion'=>$_SESSION["idPublicacion"],'categoria'=>$request->categoria,'tipo'=>$request->tipo,'marca'=>$request->input('car-marca')]);  
                break;
            default:
