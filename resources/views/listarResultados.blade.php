...
<div class="col-md-12" style="padding: 0px;    background: white;"> 
    <div class="col-md-2 col-md-offset-1" style="padding: 0px;margin-left: 65px;">
        <div class="menu-wrapper" style="padding: 0px;">
            <input type="checkbox" id="myml-menu-toggle" checked="true" disabled="">
            <nav class="myml-nav" role="complementary" style="    width: 300px;"> 
            </nav>  
        </div>
    </div>
    <div class="col-md-6" style="margin-left: 65px;width: 70%;">
                 ...
                 <li class="results-item article grid "> 
                    <div class="rowItem item item--grid item--has-row-logo new" id="MLM645463946">
                        <div class="item__image item__image--grid"> 
                            <div class="images-viewer" item-url="https://auto.mercadolibre.com.mx/MLM-645463946-bmw-z4-convertible-mt-2003-autos-puebla-_JM" item-id="MLM645463946">
                                    ...
                                    <div class="ch-carousel-mask ch-carousel-adaptive" role="tabpanel" style="height:209px"> 
                                        <ul class="ch-carousel-list" role="list"> 
                                            <li class="ch-carousel-item" role="listitem" aria-hidden="false" aria-setsize="13" aria-posinset="1" aria-label="page1" style="width: 284px;  margin-right: 0px;"> 
                                                <a href="https://auto.mercadolibre.com.mx/MLM-645463946-bmw-z4-convertible-mt-2003-autos-puebla-_JM" class="item-link item__js-link"> 
                                                    <img width="284" height="284" alt="Bmw Z4 Convertible Mt 2003 Autos Puebla" src="https://http2.mlstatic.com/D_NQ_NP_888246-MLM28276070614_102018-UB.webp" class="lazy-load" srcset="https://http2.mlstatic.com/D_NQ_NP_888246-MLM28276070614_102018-UB.webp 1x, https://http2.mlstatic.com/D_NQ_NP_888246-MLM28276070614_102018-W.webp 2x"> 
                                                </a> 
                                            </li> 
                                        </ul>
                                    </div>
