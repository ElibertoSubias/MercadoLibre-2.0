                        ...
                        <div class="row col-md-12">
                            <div class="col-md-2"> 
                                <img class="img-listo" src="../img/palomita.png" alt="">
                                 <img style="border: 2px solid #e2e2e2;padding: 0px;height: 146.08px;" src="../images/{{$datos->idUser}}/{{$datos->idPublicacion}}/{{$imagen->url}}" class="img-thumbnail" width="500" alt="">
                             </div>  
