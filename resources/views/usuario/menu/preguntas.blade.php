...
@section('titulo')
    <title>Preguntas - MercadoLibre</title>    
@stop
@section('content')  
...
<div class="app-wrapper app-wrapper--menu-expanded app-wrapper--menu-expanded-static"><div class="menu-wrapper"><input type="checkbox" id="myml-menu-toggle" checked="true" disabled=""><nav class="myml-nav" role="complementary"><div class="myml-nav__container"><section class="myml-nav__section myml-nav__section--toggle"><div class="myml-nav__section-heading"><span class="myml-nav__section-icon"><label class="myml-nav__toggle" for="myml-menu-toggle"><span class="myml-nav__ham--top"></span><span class="myml-nav__ham--middle"></span><span class="myml-nav__ham--bottom"></span><span class="myml-nav__ham--cross"></span></label></span><p class="myml-nav__section-title"><span class="myml-nav__user-permalink">Mi cuenta</span><span class="myml-nav__section-subtitle">¡Hola Eliberto!</span></p></div></section><div class="myml-nav__menu"><section class="myml-nav__section  myml-nav__section--active"><a href="https://myaccount.mercadolibre.com.mx/summary" class="myml-nav__section-heading"><span class="myml-nav__section-icon myml-nav__section-icon--myml_summary" data-tooltip="Resumen"><svg viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg></span><p class="myml-nav__section-title">Resumen</p></a></section><section class="myml-nav__section "><a href="http://localhost:88/MercadoLibre-2.0/public/estado" class="myml-nav__section-heading"><span class="myml-nav__section-icon myml-nav__section-icon--billing" data-tooltip="Facturación"><svg viewBox="0 0 15 17" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg></span><p class="myml-nav__section-title">Reputación</p></a></section><section class="myml-nav__section myml-nav__section--has-active-item"><input class="myml-nav__section-toggle-trigger" type="checkbox" id="myml-menu-section-toggle-my_purchases" checked="true"><span class="myml-nav__section-heading myml-nav__section-heading--has-items"> <label for="myml-menu-toggle" class="myml-nav__section-icon myml-nav__section-icon--my_purchases" data-tooltip="Compras"><svg viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M13.183 9h1.34V5h-1.34c-.07-.2-.15-.39-.24-.59l.94-.95-2.82-2.82-.95.94c-.2-.09-.39-.17-.59-.24V0h-4v1.34c-.2.07-.39.15-.59.24l-.95-.94-2.82 2.82.94.95c-.09.2-.17.39-.24.59H.523v4h1.34c.07.2.15.398.24.59l-.94.95 2.82 2.82.95-.94c.192.09.39.17.59.24V14h4v-1.34c.2-.07.398-.15.59-.24l.95.94 2.82-2.82-.94-.95c.09-.192.17-.39.24-.59zm-.57 1.54l-1.55 1.55-.77-.76-.57.27a4.4 4.4 0 0 1-.5.21l-.6.21v1.08h-2.2V12l-.6-.21a4.4 4.4 0 0 1-.5-.21l-.57-.27-.77.76-1.55-1.53.76-.77-.27-.57a4.4 4.4 0 0 1-.21-.5l-.19-.6h-1.1V5.9h1.1l.21-.6a4.4 4.4 0 0 1 .21-.5l.27-.57-.76-.77 1.53-1.55.77.76.57-.27a4.4 4.4 0 0 1 .5-.21l.6-.19V.9h2.2V2l.6.21c.17.06.338.13.5.21l.57.27.77-.76 1.55 1.55-.76.77.27.57c.08.162.15.33.21.5l.21.6h1.08v2.2h-1.1l-.21.6a4.4 4.4 0 0 1-.21.5l-.27.57.78.75zM7.523 4.5a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5zm0 1a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3z" fill="#999"></path>
        ...
        <div class="page-wrapper">
            <div class="page-wrapper__content"> 
                ...
                <section class="app-container" id="app-container"><div><!-- questions.questions.main -->
 

<!-- questions.header -->


    <header class="myml-header u--clearfix" data-js="header">
            ...
            <h1 class="main-title title title--primary" data-js="main-title">
                ...
                <?php $pp=count($articulos);?>
                        (<span class="questions-total" data-js="questions-total"> <?php echo count($articulos);?> </span>)
                            ...
                            <div class="open-all">
                                <input type="checkbox" data-js="open-all" name="questions-open-checkbox" id="questions-open-checkbox" value="">
                                <label for="questions-open-checkbox">Desplegar todas</label>
                            </div>
...
<div id="main-questions" class="seller">
...
<article class="item item-header" data-id="item-MLM656797491" data-js="item">
    ...
    <div class="u--arrange-fill item__content">
        ...
        <p class="item__data item__data--end-date"><span class="ch-icon-time"></span> Finaliza en 27 días.</p>

                <a class="item__edit u--no-visited" href="https://vender.mercadolibre.com.mx/item/update?itemId=MLM656797491" target="_blank">
                    <i class="ch-icon-pencil"></i>
                    <small class="edit-text">Modificar</small>
                </a>
    </div>
</article>
<!-- / questions.item.hbs -->
...
<div data-js="question"><div><!-- questions.questionsGroup.hbs -->
<div class="questions-container" data-js="questions-container">
<article data-js="questions-answer-group" class="table-list__item question question--question question--opened" id="5985364100">    <!-- questions.question.hbs -->
    <div data-js="questions-old"></div>

    <div data-href="#/preguntas/vendedor/5985364100" class="action-block action-block--alt" data-js="question__link">
        <div class="u--arrange-fit">
...
<form class="question-replay"  action="{{route('responder')}}" method="post" accept-charset="utf-8">
    ...
    <div class="ch-box-icon ch-box-error empty-field">
        <i class="ch-icon-remove-sign"></i>
            Aún tienes que escribir tu respuesta.
    </div>


    <div class="ch-box-icon ch-box-warn special-chars" data-js="special-chars">
        <i class="ch-icon-warning-sign"></i>No uses caracteres especiales
    </div>



            <div class="question-actions question-actions--classified u--clearfix">
                <div class="question-actions css-dropdown">
                    <input type="checkbox" class="question-actions__input css-dropdown-input" id="question-actions__trigger">
                    <div class="question-actions__content css-dropdown-content u--clearfix">
                        <label class="question-actions__btn css-dropdown-label mobile-visible" aria-controls="question-actions__trigger" tabindex="0" for="question-actions__trigger">
                        ...
                        <ul class="question-actions__options css-dropdown-options">
                            ...
                            <li class="question-actions__delete">
                                <!-- link -->
                                <a class="u--no-visited" href="#/preguntas/vendedor/5985364100/eliminar" data-js="delete-modal-trigger"><span class="ch-icon-trash"></span>Eliminar pregunta</a>
                            </li>
                        </ul>
                    </div>
                </div>
...
<!-- /questions.answerForm.hbs -->
</div></div>

<!-- /questions.question.hbs -->
</article></div>
...
<!-- / questions.ItemsGroup.hbs -->
    ...
    <button class="pagination-link u--no-visited" data-js="pagination-link" style="display: none;">Cargar más preguntas</button>

<div class="ch-loading ch-loading-small pagination-link-spinner" data-js="pagination-link-spinner"></div>
