...
<style type="text/css" media="screen">
    .picture-uploader .picture-uploader-preview>ul li {
    margin-bottom: 30px;
    margin: 0 8px 10px 0;
    padding-bottom: 11.3%;
}
ul li:first-of-type, li:first-of-type.sortable-dragg li:first-of-type.sortable-placeholder {
...
<div style="margin: 30px auto 20px;max-width: 1220px;background-color: #fff;border: 1px solid #e2e2e2;border-radius: 5px;height:auto;display: inline-block; ">
    <div style="" class="cont-ruta">
    	<ol class="syi-ui-wizard__breadcrumb syi-ui-wizard__step--4" data-reactid="7" style="display: block;list-style: none;    overflow: hidden;padding: 0;margin: 0 0 30px;">
    		<li class="syi-ui-wizard__step syi-ui-wizard__step--current" data-reactid="8"><span style="    background: #F0F0F0;" data-reactid="9"><a href="{{ route('vender') }}" style="color:blue !important;">Elige qué quieres publicar</a></span></li>
                ...
                <form method="post" id="upload_form" enctype="multipart/form-data" action="{{route('precio')}}"> 
                    <div class="row col-md-12">
                        ...
                        <fieldset id="categoriaSeleccionada">
                            ...
                            <p>Inmuebles > {{ $categoria }} > <strong>{{ $marca }}</strong> <a href="{{ route('categorias') }}">Modificar</a></p>
                        </fieldset>                    
                    </div>
                    <div class="row col-md-12" style="margin-top:10px;">
                        <fieldset id="grupoFotos">
                            <legend>Ingresa fotos de tu inmueble</legend>
                            <p><b>¡Tu inmueble es el protagonista!</b> No incluyas logos, banners, textos promocionales, bordes ni marcas de agua.</p> 
                            <h6> Aprovecha que la foto principal es la más grande y sube una imagen horizontal de 1200 x 900 px, nítida y bien iluminada.</h6>
                            <div class="row col-md-12">
