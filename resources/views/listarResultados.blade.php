...
<div style="width: 90%;margin: 0 auto;">
    ...
    <div style="width: 25%;float: left;text-align: left;"> 
        <div class="breadcrumb"> 
            ...
            <h1 class="breadcrumb__title">asador</h1>
        </div>
        <div class="quantity-results"> 4,640 resultados</div>
            ...
            <dl> 
                ...
                <div class="sort-by"> 
                    <div class="ui-dropdown custom"> 
                        ...
                        <label for="sort-by-options-trigger" class="ui-dropdown__link"> Más relevantes 
                            <div class="ui-dropdown__indicator"></div> 
                        </label> 
                        <div class="ui-dropdown__content sorty-by-ui-dropdown__content" style="    display: contents;"> 
                            <div class="ui-list"> 
                                <ul class="ui-list__content"> 
                                    <li class="ui-list__item ui-list__item--selected"> 
                                        <span class="ui-list__item-option" href="#">Más relevantes</span> 
                                    </li> 
                                    <li class="ui-list__item"> 
                                        <a class="ui-list__item-option" href="https://hogar.mercadolibre.com.mx/jardin-exterior-asadoras/asador_DisplayType_G_OrderId_PRICE"> Menor precio </a> 
                                    </li> 
                                    <li class="ui-list__item"> 
                                        <a class="ui-list__item-option" href="https://hogar.mercadolibre.com.mx/jardin-exterior-asadoras/asador_DisplayType_G_OrderId_PRICE*DESC"> Mayor precio </a> 
                                    </li> 
                                </ul> 
                            </div> 
                        </div> 
                ...
                <ul class="view-options-buttons"> 
                    <li> 
                        <a href="https://hogar.mercadolibre.com.mx/jardin-exterior-asadoras/asador_DisplayType_LF" title="Listado" class="ico stack"> 
