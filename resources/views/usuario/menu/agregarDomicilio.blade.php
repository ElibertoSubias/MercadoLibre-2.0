...
<fieldset class="ml-addresses-fieldset">
    ...
    <div class="ml-addresses-grid ml-addresses-grid--first-column">
        <div class="ui-form__row ">
            <input id="inputCodigoPostal" type="number" data-required="true" onkeypress="calcular(this.value)" class="ui-form__input " name="inputCodigoPostal" value="" aria-describedby="zipcodeMessage" data-valid="true" maxlength="5" data-min-length="5">
    ...
    <div class="ml-addresses-card">
        ...
        <div class="ml-addresses-grid ml-addresses-grid--second-column ui-telephone  col-md-5">
            <div class="ui-telephone__number ui-form__row">
                    <input id="inputTelefono" class="ui-telephone__input " data-js="telephone" name="inputTelefono" type="number" value="" maxlength="22" placeholder="">
