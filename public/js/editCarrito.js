function agregarinfo(preci, ids){
  ...
  var route = "../public/agregarAlCarrito";
  var token = $("#token").val();
  $.ajax({
    url: route,
...
function eliminar(id){
  ...
  var route = "../public/eliminarcarrito";
  var token = $("#token").val();
...
function modificarCantidad(caracter,idRegistro, idPublicacion, cantidadArticulos){  
	var route = "../public/modificarCantidad";
	var token = $("#token").val(); 
	  $.ajax({
	    url: route,
	    headers: {'X-CSRF-TOKEN': token},
