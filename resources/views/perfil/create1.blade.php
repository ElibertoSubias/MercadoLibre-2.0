			 ...
			 <table >
			 	...
			 	<tr>
			 		...
			 		<td style="width: 200px">
			 			<label id="lblTel"><?php if($usuario->telefono=="_"){}else{echo $usuario->telefono;}?></label>
			 			<label style="margin-left: 2px; margin-right: 100px; font-size: 12px; text-align: right;" id="tel"><?php if($usuario->telefono2=="_"){}else{echo "/".$usuario->telefono2;}?></label>
			 		</td>
