...
<fieldset class="ml-addresses-fieldset"><fieldset class="ml-addresses-fieldset">
    ...
    <div class="ml-addresses-grid ml-addresses-grid--first-column">
        <div class="ui-form__row ">
            <input id="inputCodigoPostal" type="number" data-required="true" onkeypress="calcular(this.value)" class="ui-form__input " name="inputCodigoPostal"  aria-describedby="zipcodeMessage" data-valid="true" maxlength="5" data-min-length="5">
