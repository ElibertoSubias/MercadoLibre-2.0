                ...
                <input type="hidden" name="idPublicacion" id="idPublicacion" value="{{$datos->idPublicacion}}">
                    <div class="row col-md-11" style="text-align: left;margin-bottom: 60px;">
                        <div class="row col-md-12">
                            <div class="col-md-2"> 
                                <img class="img-listo" src="/MercadoLibre-2.0/public/img/palomita.png" alt="">
                                 <img style="border: 2px solid #e2e2e2;padding: 0px;height: 146.08px;" src="/MercadoLibre-2.0/public/images/{{ auth()->user()->_id }}/{{$datos->idPublicacion}}/{{$imagen->url}}" class="img-thumbnail" width="500" alt="">
                             </div> {{$datos->idPublicacion}} 
                             <div class="col-md-8 cont-listo">
                                 ...
                                 <a href="{{route('verpublicacion', ['id' => $datos->_id])}}" title="" class="ch-btn-small">Ver publicación</a>
