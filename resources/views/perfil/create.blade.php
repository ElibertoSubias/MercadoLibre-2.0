...
@section('titulo')
  <title>Mis datos - MercadoLibre</title>  
@stop
@section('content')  
        ...
        <div class="page-wrapper">
            <div class="page-wrapper__content"> 
                ...
                <section id="listContainer" class="container" data-js="data-container"> 
                  <h1 class="myml-title">Mis Datos</h1>  
        <div class="col-md-12 cont_principal_perfil" style="background: white;padding-bottom: 100px;width: 99%;padding-left: 0px;">  

                <div class="row" style="text-align: right;padding: 0px;    margin-left: 0px;">
