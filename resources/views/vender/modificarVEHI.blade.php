...
<div style="margin: 30px auto 20px;max-width: 1220px;background-color: #fff;border: 1px solid #e2e2e2;border-radius: 5px;height:auto;display: inline-block; "> 
    <div style="position: relative;">
            <div style="width: 100%;height: 100%;text-align: left;margin:20px;">
                <h2 style="font-size: 20px;margin-top: -10px;margin-bottom: 0px;">Modificar publicación</h2>
                <form method="post" id="upload_form" enctype="multipart/form-data" action="{{route('modificarPublicacion')}}"> 
                    <div class="row col-md-12"> 
                        ...
                        <input type="hidden" name="categoria" id="categoria" value="{{ $datos->categoria }}">
                        <input type="hidden" name="tipo" id="tipo" value="VEHI">
                        <input type="hidden" name="idItem" id="idItem" value="{{$datos->_id}}">
                        <input type="hidden" name="marca" id="marca" value="{{ $datos->marca }}">
                                ...
                                <div class="picture-uploader  picture-uploader-motors ">
                                    ...
                                    <div class="picture-uploader-preview " id="picture-uploader-preview" style="position: relative;z-index: 1;">
                                        <ul>
                                            ...
                                            @for ($i = 0; $i < 14; $i++)
                                                @if(@isset($imagen[$i]->_id))
                                                    @if($imagen[$i]->url!="")
                                                        @if($imagen[$i]->tipoImg=="principal")
                                                            <li data-picture-status="on" class="off" id="principal" onclick="clickbtn(id)"> 
                                                                <img src="/MercadoLibre-2.0/public/images/{{$datos->idUser}}/{{$datos->idPublicacion}}/{{$imagen[$i]->url}}" class="img-thumbnail" width="300" />
                                                    ...
                                                    @else
                                                        @if($imagen[$i]->tipoImg=="principal")
                                                            <li data-picture-status="on" class="off" id="principal" onclick="clickbtn(id)"> 
                                                                ...
                                                                <div class="picture-uploader-controls">
                                                                    <p role="button" class="ch-close ch-hide"><span class="ch-hide">x</span></p>
                                                                </div>
                                                                <p class="picture-uploader-principal">Foto principal</p>
                                                            </li>   
                                                        @else
                    ...
                    <div class="row col-md-12">
                        <fieldset>
                            ...
                            <div class="col-md-4">
                                <input class="form-control col-md-4" type="text" name="urlvideo" id="urlvideo" value="{{$datos->urlvideo}}">
                    ...
                    <div class="row col-md-12">
                        ...
                        <fieldset id="QuantityPriceGroup"style="margin-top: 4%;">
                            <legend class="{2}" >Precio de venta</legend> 
                            <div id="category" data-value="MLM117653"></div> 
                                <p class="ch-form-hint">* Datos obligatorios</p> 
                                <div class="price-content" data-js="price-container" style="margin-left: 8%;"> 
                                <div class="ch-form-row ch-form-required option-price " data-js="price-component"> 
                                        <label for="price" style="float: left;"> 
                                            Precio :   <em>*</em>                                            
                                        </label> 
                                        <select name="moneda" id="moneda" class="currency" data-js="currency" style="float: left;    margin: 5px;"> 
                                                <option value="MXN" selected="">$</option>
                                            
                                                <option value="USD">U$S</option> 
                                        </select> 
                                        <span class="price-input" style="float: left;">
                                            <input type="tel" value="{{$datos->precio}}" name="precio" id="precio" class="price" title="Completa este dato" size="15" min="1" maxlength="14" data-js="price" data-price-decimal-separator="." data-price-decimal-places="0">
                                        </span>
                    ...
                    <div class="row col-md-12" id="footer-descripcion"> 
                        <input type="submit"  class="btn-azul" name="des-continuar2" id="btn-continuar2" value="Guardar" style="font-size: 18px;padding: 6px 12px;margin-top:0px">
                        <a href="{{ URL::previous() }}" title="">Volver a ver Publicaciones</a>
                    </div>
                </form>
            </div>
    </div> 
