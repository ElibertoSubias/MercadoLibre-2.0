...
@section('titulo')
	<title>Crear cuenta personal - MercadoLibre</title>	
@stop
@section('content') 
<main class="main_aut_email col-md-12" style="margin: 0px;padding: 0px;font-family: Proxima Nova,-apple-system,Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;    font-size: 16px;    font-weight: 300;    line-height: 1.35;
	...
	<div class=" row col-md-8 col-md-offset-2" style="margin-right: 0px;"> 
				...
				<div class="col-md-10 col-md-offset-1"> 
					{!! Form::open(['url'=>'login', 'method'=>'POST', 'id'=>'frmInsertarUsuario', 'name'=>'frmInsertarUsuario','autocomplete'=>'off']) !!} 
					<input type="hidden" name="_token" value="{{ csrf_token() }}" id="token"> 
						<div id="cont-form1" style="background: #fff;    display: table;padding: 1px 32px 60px;box-shadow: 0 1px 3px 0 rgba(0,0,0,.3);-webkit-border-radius: 0 0 4px 4px;border-radius: 0 0 4px 4px;">
							...
							<div class="col-md-6" style="height: 30px;">
								...
								<div id="alertMsjinputClave" class="ch-validation-message ui-form__message"></div>
							</div>
						</div>  
				</div> 
