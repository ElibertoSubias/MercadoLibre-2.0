...
<form style="margin-bottom:0px;" class="ui-form form-with-floating-labels" id="addresses-form" action="" name="addresses-form" method="post">
    ...
    <div class="u-clearfix">
        ...
        <div class="ml-addresses-grid ml-addresses-grid--second-column ml-addresses-grid--half-column">
            <div class="ui-form__row ">
                <input id="inputNumExt" type="tel" data-required="true" class="ui-form__input " name="inputNumExt" value="" data-valid="true" aria-describedby="numberMessage" maxlength="8" data-min-length="1">
    ...
    position: absolute;">s/n</span>
        ...
        <div class="ml-addresses-grid ml-addresses-grid--second-column ml-addresses-grid--half-column">
            <div class="ui-form__row ">
                <input id="inputNumInt" type="text" class="ui-form__input " name="inputNumInt" value="" aria-describedby="commentMessage" data-valid="true" maxlength="150" data-required="false" data-min-length="-1">
