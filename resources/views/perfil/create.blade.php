        ...
        <div class="col-md-12" style="padding-left: 55px;">  
            <form>
             ...
             <table>
                <tr>
                    <td>Usuario</td>
                    <td style="text-align: left;margin-left: 20px;">{{ auth()->user()->alias }}</td>
                    <td style="text-align: left;margin-left: 20px;"><a href="editarusuario"> Modificar</a> </td>
                </tr>
                <tr>
                    <td>E-mail</td>
                    <td style="text-align: left;margin-left: 20px;">{{ auth()->user()->email }}</td>
                    <td style="text-align: left;margin-left: 20px;"><a href="editarcorreo"> Modificar</a> </td>
                </tr>
                <tr>
                    <td>Clave</td>
                    <td style="text-align: left;margin-left: 20px;">********</td>
                    <td style="text-align: left;margin-left: 20px;"><a href=editarpassword> Modificar</a> </td>
                </tr>
             </table>
             <p class="H3_1">Datos personales <a href="#" style="padding-left: 270px; font-size: 12px">Necesito ayuda</a> </p>
              
             <table class="nombre-user">
                <tr>
                    <td >Nombre y apellido</td>
                    <td style="padding-left: 20px;text-align: left;">{{ auth()->user()->nombre }} {{$usuario->apellido}}</td>
                    <td><a href="javascript:openventana()"> Modificar</a> </td>
                </tr>
                <tr>
                    <td >documentos</td>
                    <td style="padding-left: 20px;text-align: left;"><?php if($usuario->documento=="_"){}else{echo $usuario->documento;}?></td>
                ...
                <tr>
                    ...
                    <td style="width: 200px">
                        <label id="lblTel">
                            <?php if($usuario->telefono=="_"){}else{echo $usuario->telefono;}?>
                        </label>
                        <label style="margin-left: 2px; margin-right: 100px; font-size: 12px; text-align: right;" id="tel">
                            <?php if($usuario->telefono2=="_"){}else{echo "/".$usuario->telefono2;}?>   
                        </label>
                    </td>
