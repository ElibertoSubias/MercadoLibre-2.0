                            ...
                            <div class="col-md-12" style="padding-left: 6%;padding-top: 1%;">
                                <div class="ui-form-row" data-reactid="43" style="margin-bottom: 2%;">
                                	<span data-reactid="44">
                                		...
                                		<input style="width: 5%;" type="text" data-hj-whitelist="true" label="Cantidad:<em>*</em>" required="" value="1" maxlength="5" class="syi-quantity__field" id="cantidad" name="cantidad">
                                	</span>
                                </div>
                                <div class="col-md-4">
