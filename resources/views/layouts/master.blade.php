...
<div class="user-menu__user-info-outer-container">
  ...
  <a href="{{route('estado')}}" class="user-menu__primary-action ui-button ui-button--primary" data-id="my-account" rel="nofollow">
    ...
    <a href="{{route('historialVentas')}}" rel="nofollow">
      Ventas
    </a>
...
(function(win, doc){
  ...
  var scripts = ["js/kenshoo-ktag-mlm.js",function(){
      ...
      window.freya = mitt();
    },"js/snackbar.js",function(){(function (bus) {
...
})(window.freya || window.meli);},"js/user-menu.js","js/modeless-box.js",function(){
...
freya.on('bookmarks:show:before', function(ev) {
    ...
    },"js/CartWidget.js",function(){
          
        },"js/modal.js",function(){
    (function () {
