				    ...
				    <div class="carousel__cell">
				    	<a class="exhibitor-item" href="#">
							<div class="exhibitor-holder">
								<img src="img/mlm_movil.jpg" alt="canon">
							</div>
						</a>
				    </div>
				    <div class="carousel__cell">
				    	<a class="exhibitor-item" href="#">
							<div class="exhibitor-holder">
								<img src="img/mlm_navidad.jpg" alt="Feria del bebé ">
							</div>
						</a>
				    </div>
				    <div class="carousel__cell">
				    	<a class="exhibitor-item" href="#">
							<div class="exhibitor-holder">
								<img src="img/mlm_ropa.jpg" alt="Festejemos México ">
							</div>
						</a>
				    </div> 
				    <div class="carousel__cell">
				    	<a class="exhibitor-item" href="#">
							<div class="exhibitor-holder">
								<img src="img/mlm_muebles.jpg" alt="marcas mexicanas">
							</div>
						</a>
				    </div>
				    <div class="carousel__cell">
				    	<a class="exhibitor-item" href="#">
							<div class="exhibitor-holder">
								<img src="img/mlm_brujas.jpg" alt="canon">
							</div>
						</a>
				    </div> 
				  </div>
