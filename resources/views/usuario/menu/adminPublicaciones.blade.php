                            ...
                            <fieldset>
                                ...
                                <p class="ch-form-row">
                                    <label class="required modif-title" for="title">
                                        ...
                                        <input type="text" id="title" value="{{$venta->titulo}}" name="title" maxlength="60" class="ch-points-ltrt">
                                ...
                                <div class="ch-form-row ch-form-row-price-fix">
                                    ...
                                    <select data-js="currency" id="currencyId">
                                        <option value="USD">U$S</option>
                                        <option value="MXN" selected="">$</option>
                                    </select>
                                    <input type="text" data-js="price" class="allprice ch-points-ltrt" name="priceTot" id="priceTot" value="{{$venta->precio}}" size="15">
                                ...
                                <p class="ch-form-row"> 
                                    ...
                                    <input type="text" id="km" value="{{$venta->kilometros}}" name="km" maxlength="10">
                                </p> 
                                <!-- Teléfono 1-->
                                <div class="ch-form-row telephone-contact">
                                    ...
                                    <div class="ui-telephone ui-telephone--with-flag ui-telephone--change-flag ui-telephone--success">
                                        <div class="ui-telephone__number"><div class="ui-telephone__flags"><div class="ui-telephone__selected-flag"><div class="ui-telephone__flag-icon ui-telephone__flag-icon--mx"></div></div><div class="ui-telephone__flags-list"><ul class="ui-telephone__flags-list-ul"><li data-country="mx" class="ui-telephone__flags-list-item"><div class="ui-telephone__flag-icon ui-telephone__flag-icon--mx"></div><span class="ui-telephone__flag-name">México</span><span class="ui-telephone__flag-code">52</span></li></ul></div></div>
                                            <input id="telephone1" class="ui-telephone__input ch-points-ltrt" type="tel" required="" value="{{$venta->telefono}}" data-validations="tel-validations" data-country="52" data-country-code="val_tel_country_code1" data-area-code="val_tel_pref" data-number="val_tel1" maxlength="22" placeholder="222 1234567">
                                ...
                                <div class="ch-form-row telephone-contact">
                                    ...
                                    <div class="ui-telephone ui-telephone--with-flag ui-telephone--change-flag">
                                        <div class="ui-telephone__number"><div class="ui-telephone__flags"><div class="ui-telephone__selected-flag"><div class="ui-telephone__flag-icon ui-telephone__flag-icon--mx"></div></div><div class="ui-telephone__flags-list"><ul class="ui-telephone__flags-list-ul"><li data-country="mx" class="ui-telephone__flags-list-item"><div class="ui-telephone__flag-icon ui-telephone__flag-icon--mx"></div><span class="ui-telephone__flag-name">México</span><span class="ui-telephone__flag-code">52</span></li></ul></div></div>
                                            <input id="telephone2" class="ui-telephone__input ch-points-ltrt" type="tel" value="{{$venta->telefono2}}" data-validations="tel-validations2" data-country="MX" data-country-code="val_tel_country_code2" data-area-code="val_tel_pref2" data-number="val_tel2" maxlength="22" placeholder="222 1234567">
